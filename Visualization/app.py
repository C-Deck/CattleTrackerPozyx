...
from Helper.figureBuilder import getInitialData, getFrames, getAllInitialData, getAllFrames, addTracesToFigure, buildSpeciesBarChart
from Helper.statBuilder import generateTagPlotTimeTable, getPlots, buildTags, buildTagData, generateTagSpeciesTimeTable
...
''' 
 Uncomment the one below and comment the one two below to be able to see the points moving easier
'''
